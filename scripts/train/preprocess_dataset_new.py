...
# Original: scripts/train/preprocess_dataset_new.py from ace-step and woct0rdho fork
# Upstream repos:
...
# Modifications: Reworked preprocessing pipeline for consumer GPU, path normalization, HDF5 options and performance tweaks. See `third_party/THIRD_PARTY_LICENSES.md` for provenance and file-level notes.
...
def main():
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default=r"data\data_sets\train_set",
        help="Directory to save the preprocessed dataset.",
    )
    parser.add_argument(
        "--checkpoint_dir",
        type=str,
        default=r"Z:\AI\projects\.models\generative\music",
