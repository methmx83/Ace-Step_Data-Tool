...
# File: scripts/train/trainer_optimized.py (renamed from trainer_new.py)
...
# Notes: Extensive refactor and optimisations for consumer GPU (quantisation hints, save callback). See THIRD_PARTY_LICENSES.md for provenance.
